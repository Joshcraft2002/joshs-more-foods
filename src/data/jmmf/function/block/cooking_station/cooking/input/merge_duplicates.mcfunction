...
execute if score jmmf:temp1 jmmf.data matches 1.. if score jmmf:temp2 jmmf.data matches 1 run function jmmf:block/cooking_station/cooking/input/merge_duplicates/0
execute if score jmmf:temp1 jmmf.data matches 2.. if score jmmf:temp2 jmmf.data matches 1 run function jmmf:block/cooking_station/cooking/input/merge_duplicates/1
execute if score jmmf:temp1 jmmf.data matches 3.. if score jmmf:temp2 jmmf.data matches 1 run function jmmf:block/cooking_station/cooking/input/merge_duplicates/2
execute if score jmmf:temp1 jmmf.data matches 4.. if score jmmf:temp2 jmmf.data matches 1 run function jmmf:block/cooking_station/cooking/input/merge_duplicates/3
execute if score jmmf:temp1 jmmf.data matches 5.. if score jmmf:temp2 jmmf.data matches 1 run function jmmf:block/cooking_station/cooking/input/merge_duplicates/4
execute if score jmmf:temp1 jmmf.data matches 6.. if score jmmf:temp2 jmmf.data matches 1 run function jmmf:block/cooking_station/cooking/input/merge_duplicates/5
