...
execute unless data storage jmmf:cooking_station {input:{ingredients:[{id:"minecraft:porkchop", count:1}], container:{id:"jmmf:pie_crust"}}} run return fail
...
item modify entity @s weapon.mainhand jmmf:item/pork_pie
