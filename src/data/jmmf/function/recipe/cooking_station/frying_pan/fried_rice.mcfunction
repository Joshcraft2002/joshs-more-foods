...
execute unless data storage jmmf:cooking_station {input:{ingredients:[{tag:["smithed:rice"], count:2}, {id:"minecraft:carrot", count:1}, {id:"minecraft:potato", count:1}, {id:"minecraft:egg", count:1}], container:{id:"minecraft:bowl"}}} run return fail
...
item modify entity @s weapon.mainhand jmmf:item/fried_rice
