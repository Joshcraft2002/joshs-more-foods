...
execute unless function jmmf:recipe/cooking_station/frying_pan/fried_egg/ingredients run return fail
...
execute if score @s jmmf.count.output matches 16.. run return fail
