...
execute unless data storage jmmf:cooking_station {input:{ingredients:[{id:"jmmf:red_rice", count:2}], container:{id:"minecraft:bowl"}}} run return fail
...
item modify entity @s weapon.mainhand jmmf:item/red_rice_bowl
