...
return run execute if score @s jmmf.count matches 2 if data storage jmmf:cooking_station {input:{ingredients:[{id:"minecraft:bone", count:1}, {id:"minecraft:carrot", count:1}]}}
