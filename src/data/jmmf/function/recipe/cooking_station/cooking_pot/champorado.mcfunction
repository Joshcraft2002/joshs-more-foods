...
execute unless data storage jmmf:cooking_station {input:{ingredients:[{tag:["smithed:rice"], count:1}, {id:"minecraft:cocoa_beans", count:1}], container:{id:"minecraft:bowl"}}} run return fail
...
item modify entity @s weapon.mainhand jmmf:item/champorado
