...
execute unless data storage jmmf:cooking_station {input:{ingredients:[{id:"minecraft:bone", count:1}, {id:"minecraft:carrot", count:1}], container:{id:"minecraft:bowl"}}} run return fail
