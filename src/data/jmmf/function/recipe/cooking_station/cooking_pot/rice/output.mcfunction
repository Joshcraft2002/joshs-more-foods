...
execute if score @s jmmf.count.output matches 0 run item replace block ~ ~ ~ container.16 with minecraft:wheat
execute if score @s jmmf.count.output matches 0 run item modify block ~ ~ ~ container.16 jmmf:rice
