...
execute unless data storage jmmf:cooking_station {input:{ingredients:[{tag:["minecraft:eggs"], count:1}]}} run return fail
...
item modify entity @s weapon.mainhand jmmf:item/boiled_egg
