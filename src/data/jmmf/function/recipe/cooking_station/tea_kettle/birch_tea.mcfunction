...
execute unless data storage jmmf:cooking_station {input:{ingredients:[{id:"minecraft:birch_leaves", count:3}, {id:"jmmf:tea_leaves", count:2}], container:{id:"jmmf:teacup"}}} run return fail
...
item modify entity @s weapon.mainhand jmmf:item/birch_tea
