...
execute unless data storage jmmf:cooking_station {input:{ingredients:[{id:"jmmf:tea_leaves", count:3}], container:{id:"jmmf:teacup"}}} run return fail
...
item modify entity @s weapon.mainhand jmmf:item/green_tea
