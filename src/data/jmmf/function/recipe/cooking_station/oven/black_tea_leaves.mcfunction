...
execute unless data storage jmmf:cooking_station {input:{ingredients:[{id:"jmmf:tea_leaves", count:1}]}} run return fail
...
item modify entity @s weapon.mainhand jmmf:item/black_tea_leaves
