...
execute if score @s jmmf.count.7 matches 0 run item replace block ~ ~ ~ container.16 with cookie[custom_data={smithed:{id:"jmmf:boiled_egg"}},custom_model_data=481006,item_name='{"italic":false,"translate":"item.jmmf.boiled_egg"}', food={nutrition:3,saturation:2}]
