...
execute if score @s jmmf.count.7 matches 0 run item replace block ~ ~ ~ container.16 with minecraft:rotten_flesh[custom_data={joshmats:{id:"jmmf:rotten_stew"}},custom_model_data=481190,item_name='{"italic":false,"translate":"item.jmmf.rotten_stew"}',lore=['{"italic":false, "translate":"item.jmmf.rotten_stew.lore", "color":"gray"}']]
