...
execute if score @s jmmf.count.7 matches 0 run item replace block ~ ~ ~ container.16 with wheat[custom_data={joshmats:{id:"jmmf:rice",tag:"rice"}},custom_model_data=481001,item_name='{"italic":false,"translate":"item.jmmf.rice"}']
