...
execute if score @s jmmf.count.7 matches 0 run item replace block ~ ~ ~ container.16 with cookie[custom_data={smithed:{id:"jmmf:cornflower_tea"},joshmats:{tag:["tea"]}},custom_model_data=481361,item_name='{"italic":false,"translate":"item.jmmf.cornflower_tea"}',food={nutrition:1,saturation:0.5,can_always_eat:true,effects:[{effect:{id:"minecraft:regeneration",duration:400}}]},max_stack_size=16]
