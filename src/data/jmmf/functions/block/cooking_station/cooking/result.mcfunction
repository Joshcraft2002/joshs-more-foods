...
execute if score @s jmmf.recipe_id matches 133 run function jmmf:block/cooking_station/cooking/recipes/chicken_pot_pie/output
...
execute if score @s jmmf.recipe_id matches 360 run function jmmf:block/cooking_station/cooking/recipes/sweet_berry_tea/output
execute if score @s jmmf.recipe_id matches 361 run function jmmf:block/cooking_station/cooking/recipes/cornflower_tea/output
execute if score @s jmmf.recipe_id matches 362 run function jmmf:block/cooking_station/cooking/recipes/dandelion_tea/output
execute if score @s jmmf.recipe_id matches 363 run function jmmf:block/cooking_station/cooking/recipes/green_tea/output
execute if score @s jmmf.recipe_id matches 364 run function jmmf:block/cooking_station/cooking/recipes/rose_tea/output
execute if score @s jmmf.recipe_id matches 365 run function jmmf:block/cooking_station/cooking/recipes/spruce_tea/output
execute if score @s jmmf.recipe_id matches 366 run function jmmf:block/cooking_station/cooking/recipes/sakura_tea/output
