...
execute if score jmmf:temp2 jmmf.data matches 0 store result storage jmmf:cooking_station input.ingredients[5].Count byte -1 run data get storage jmmf:cooking_station input.ingredients[5].Count -1.000001
